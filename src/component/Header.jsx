    ...
    <>
      <div className='header px-[30px] py-[20px] flex justify-between items-center bg-[#fff]'>
        ...
        <ul className='md:flex hidden lg:gap-x-[40px] md:gap-x-[20px] items-center'>
          <li><Link className='primary-font text-[16px] font-[500] text-[#1E1E1E]' to="/categories">Actor</Link></li>
          <li><Link className='primary-font text-[16px] font-[500] text-[#1E1E1E]' to="/categories">Politicians</Link></li>
        ...
        <div className='lg:w-[200px] flex justify-end'>
          <Button btnlink="/login" btntext="Login" />
